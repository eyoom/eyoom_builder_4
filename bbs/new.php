...
$gr_id = isset($gr_id) ? substr(preg_replace('/[^a-z0-9_]/i', '', $gr_id), 0, 10) : '';
if ($gr_id) {
    $sql_common .= " and b.gr_id = '" . sql_real_escape_string($gr_id) . "' ";
}
...
if ($mb_id) {
    $sql_common .= " and a.mb_id = '" . sql_real_escape_string($mb_id) . "' and a.wr_anonymous <> '1' and a.wr_bo_anonymous <> '1' ";
}
