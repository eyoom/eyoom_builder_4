...
<div class="myhome-follow">
    <div class="follow-heading">
        ...
        <strong>
            <?php if ($user['mb_id'] == $member['mb_id']) { ?>나의 팔로윙<?php } else { ?><?php echo $user['mb_nick']; ?> 님의 팔로윙<?php } ?>
            <small class="font-normal margin-left-5">( <span class="color-green"><?php if ($user['cnt_following']) { ?><?php echo number_format($user['cnt_following']); ?><?php } else { ?>0<?php } ?>명</span> )</small>
        </strong>
    </div>
    <div class="infinite-container">
        ...
        <div class="text-center color-grey font-size-14 margin-top-30">
            <i class="fa fa-exclamation-circle"></i> 팔로우한 회원이 없습니다.
        </div>
        <?php } ?>
    </div>
