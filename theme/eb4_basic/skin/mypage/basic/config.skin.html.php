...
<style>
.my-config .config-box {position:relative;background:#fff;border:1px solid #eaeaea;padding:15px;margin-bottom:30px}
</style>
...
<div class="my-config">
    ...
    <div class="headline-short">
        <h4><strong>기본설정</strong></h4>
        <div class="headline-btn">
            <input type="submit" class="btn-e btn-e-sm btn-e-dark" value="적용하기">
        </div>
    </div>
    ...
    <div class="text-center margin-top-50">
        <input type="submit" class="btn-e btn-e-xlg btn-e-red" value="적용하기">
    </div>
