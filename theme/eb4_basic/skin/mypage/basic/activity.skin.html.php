...
.my-activity .timeline > li > .timeline-badge {width:14px;height:14px;position:absolute;background:#e53935;margin:0;border:2px solid #fff;box-shadow:0 0 0 1px #b5b5b5;border-radius:50%;top:35px;right:-6px;z-index:9}
