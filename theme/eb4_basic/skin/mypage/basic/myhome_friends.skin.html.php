...
<div class="myhome-follow">
    <div class="follow-heading">
        ...
        <strong>
            ...
            <span class="m-l-5">[ <span class="text-blue"><?php if ($user['cnt_friends']) { ?><?php echo number_format($user['cnt_friends']); ?><?php } else { ?>0<?php } ?>명</span> ]</span>
        </strong>
    </div>
                    ...
                    <div class="follow-info-content">
                        ...
                        <div id="follow_<?php echo $list[$i]['mb_id']; ?>" class="profile-btns">
                            ...
                            <?php if ($list[$i]['mb_id'] == $member['mb_id']) { ?>
                                <button type="button" class="btn-e btn-e-crimson">It's Me!<i class="fas fa-child m-l-5"></i></button>
                            <?php } else { ?>
