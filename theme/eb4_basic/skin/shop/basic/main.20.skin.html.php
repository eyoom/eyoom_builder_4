...
.product-main-20 .item-main-20-in {position:relative;background:#fff;margin-bottom:20px;-webkit-transition:all 0.2s ease-in-out;transition:all 0.2s ease-in-out}
.product-main-20 .product-img {position:relative;overflow:hidden;border-radius:7px;margin-bottom:10px;background:#fff}
...
.product-main-20 .product-description .title-price {font-size:1.125rem;font-weight:700;color:#ab0000;margin-right:7px}
...
.product-main-20 .product-description .product-sns ul li a {display:block;width:28px;height:28px;display:flex;align-items:center;justify-content:center;background:#a5a5a5}
.product-main-20 .product-description .product-sns ul li img {width:12px;height:12px}
.product-main-20 .product-description .product-sns ul li:hover .wish-icon {background:#ab0000}
.product-main-20 .product-description .product-sns ul li:hover .facebook-icon {background:#39558f}
.product-main-20 .product-description .product-sns ul li:hover .twitter-icon {background:#252525}
.product-main-20 .product-description-bottom {position:relative;overflow:hidden;padding:12px 0;border-top:1px solid #e5e5e5}
...
.product-main-20 .shop-rgba-red {background:#ab0000}
