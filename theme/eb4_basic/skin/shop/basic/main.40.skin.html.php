...
<style>
.product-main-40 {position:relative;overflow:hidden}
.product-main-40-in {margin-left:-10px;margin-right:-10px}
.product-main-40 .item-main-40 {position:relative;padding-left:10px;padding-right:10px;outline:none}
.product-main-40 .item-main-40-in {position:relativebackground:#fff;margin-bottom:20px;-webkit-transition:all 0.2s ease-in-out;transition:all 0.2s ease-in-out}
...
.product-main-40 .item-main-40-in:hover .product-img-in .second-img {display:block}
...
.product-main-40 .product-img-in .discount-percent {position:absolute;top:-40px;left:-40px;width:80px;height:80px;padding-top:57px;text-align:center;background:#cc2300;color:#fff;font-style:italic;font-size:.75rem;-webkit-transform:rotate(-45deg);-moz-transform:rotate(-45deg);transform:rotate(-45deg)}
.product-main-40 .product-description .product-description-in {position:relative;overflow:hidden;padding:0 0 10px}
.product-main-40 .product-description .product-name {position:relative;overflow:hidden;margin:10px 0 5px;font-size:1.125rem;font-weight:700;line-height:1.4;height:48px}
...
.product-main-40 .product-description .title-price {font-size:1.125rem;font-weight:700;color:#cc2300;margin-right:7px}
.product-main-40 .product-description .line-through {font-size:.9375rem;color:#959595;text-decoration:line-through;font-weight:400;white-space:nowrap}
...
.product-main-40 .product-description .product-sns {position:relative;height:30px;margin-top:10px}
.product-main-40 .product-description .product-sns ul {position:absolute;top:0;right:0;margin:0;padding:0;list-style:none}
.product-main-40 .product-description .product-sns ul:after {content:"";display:block;clear:both}
.product-main-40 .product-description .product-sns ul li {float:left;margin-left:1px}
.product-main-40 .product-description .product-sns ul li a {display:block;width:30px;height:30px;line-height:30px;text-align:center;background:#b5b5b5;color:#fff;font-size:.75rem}
.product-main-40 .product-description .product-sns ul li:hover .wish-icon {background:#cc2300}
.product-main-40 .product-description .product-sns ul li:hover .facebook-icon {background:#39558f}
.product-main-40 .product-description .product-sns ul li:hover .twitter-icon {background:#4698e0}
.product-main-40 .product-description-bottom {position:relative;overflow:hidden;padding:12px 0;border-top:1px solid #e5e5e5}
.product-main-40 .product-description-bottom a:hover {text-decoration:underline;color:#000}
.product-main-40 .product-ratings {width:75px;margin:0;padding:0}
...
.product-main-40 .product-ratings li .rating-selected {color:#cc2300;font-size:.8125rem}
.product-main-40 .shop-rgba-red {background:#cc2300}
.product-main-40 .shop-rgba-yellow {background:#ff9500}
.product-main-40 .shop-rgba-green {background:#00897b}
.product-main-40 .shop-rgba-purple {background:#8e24aa}
.product-main-40 .shop-rgba-orange {background:#f4511e}
.product-main-40 .shop-rgba-dark {background:#3c3c3e}
.product-main-40 .shop-rgba-default {background:#A6A6A6}
.product-main-40 .rgba-banner-area {position:absolute;top:0;right:0}
.product-main-40 .rgba-banner {height:18px;width:70px;line-height:18px;color:#fff;font-size:.6875rem;text-align:center;font-weight:400;position:relative;text-transform:uppercase;margin-bottom:1px}
.product-main-40 .item-main-40-in:hover .product-name a {text-decoration:underline}
.product-main-40 .slick-dotted.slick-slider {margin-bottom:40px}
.product-main-40 .slick-dots li {display:inline-block;margin:0 1px;width:30px;height:3px;background:#959595}
.product-main-40 .slick-dots li button:before {content:"";width:100%;height:3px;-webkit-transition:all .2s linear;transition:all .2s linear;opacity:1}
.product-main-40 .slick-dots li.slick-active button:before {background:#cc2300}
.product-main-40 .slick-next, .product-main-40 .slick-prev {width:50px;height:50px;line-height:50px;text-align:center;border:1px solid #e5e5e5;-webkit-transition:all .2s linear;transition:all .2s linear}
.product-main-40 .slick-next:hover, .product-main-40 .slick-prev:hover {border:1px solid #757575}
.product-main-40 .slick-next {top:inherit;bottom:-60px;right:10px;z-index:1}
.product-main-40 .slick-prev {top:inherit;bottom:-60px;left:10px;z-index:1}
.product-main-40 .slick-next:before, .product-main-40 .slick-prev:before {font-family:'Font Awesome\ 5 Free';font-weight:900;color:#000;font-size:.9375rem;line-height:inherit}
...
@media (max-width:1199px) {
    ...
    .product-main-40 .slick-next {right:5px}
    .product-main-40 .slick-prev {left:5px}
}
@media (max-width:767px) {
    .product-main-40-in {margin-left:-2px;margin-right:-2px}
    .product-main-40 .item-main-40 {padding:0 2px}
    .product-main-40 .slick-next {right:2px}
    .product-main-40 .slick-prev {left:2px}
}
</style>
