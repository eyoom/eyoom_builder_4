...
.product-main-40 .item-main-40-in {position:relative;margin-bottom:20px;-webkit-transition:all 0.2s ease-in-out;-moz-transition:all 0.2s ease-in-out;-o-transition:all 0.2s ease-in-out;transition:all 0.2s ease-in-out}
.product-main-40 .product-img-wrap {position:relative;border:1px solid #e5e5e5;background:#fff;margin-bottom:10px}
.product-main-40 .product-img {position:relative;overflow:hidden;margin:5px;background:#fff}
.product-main-40 .product-img:after {content:"";position:absolute;display:block;left:0;top:0;opacity:0;-moz-transition:all 0.2s ease 0s;-webkit-transition:all 0.2s ease 0s;-ms-transition:all 0.2s ease 0s;-o-transition:all 0.2s ease 0s;transition:all 0.2s ease 0s;width:100%;height:100%;background:rgba(0,0,0,0.3)}
...
.product-main-40 .product-img-in img {display:block;width:100% \9;max-width:100% !important;height:auto !important;position:absolute;top:0;left:0;right:0;bottom:0}
.product-main-40 .product-description .product-description-in {position:relative;overflow:hidden;padding:0 0 10px}
.product-main-40 .product-description .product-name {position:relative;overflow:hidden;margin:10px 0 5px;height:40px}
.product-main-40 .product-description .product-name a {font-size:15px;font-weight:bold;color:#000}
.product-main-30 .product-description .product-name a:hover {color:#FF4848;text-decoration:underline}
.product-main-40 .product-description .title-price {font-size:16px;font-weight:bold;color:#E52700}
.product-main-40 .product-description .line-through {font-size:12px;color:#959595;text-decoration:line-through;margin-left:7px;font-weight:normal}
.product-main-40 .product-description .product-sns {position:relative;text-align:right;margin-top:8px}
.product-main-40 .product-description .product-sns ul {margin:0;padding:0;list-style:none}
.product-main-40 .product-description .product-sns ul li {display:inline-block}
.product-main-40 .product-description .product-sns ul li a {display:inline-block;width:26px;height:26px;line-height:26px;text-align:center;background:#c5c5c5;color:#fff;font-size:12px;border-radius:50% !important}
.product-main-40 .product-description .product-sns ul li:hover .facebook-icon {background:#5D82D1}
.product-main-40 .product-description .product-sns ul li:hover .twitter-icon {background:#40BFF5}
.product-main-40 .product-description .product-sns ul li:hover .google-icon {background:#EB5E4C}
.product-main-40 .product-description .product-sns ul li:hover .wish-icon {background:#FF9500}
.product-main-40 .product-ratings {margin:0;padding:0;margin-right:3px}
...
.product-main-40 .product-ratings li .rating-selected {color:#FF2900;font-size:11px}
...
.product-main-40 .item-main-40:hover .product-img:after {opacity:1}
.product-main-40 .item-main-40:hover .product-name a {text-decoration:underline}
.product-main-40 .slick-next {top:inherit;bottom:-34px;right:5px;z-index:1}
.product-main-40 .slick-prev {top:inherit;bottom:-34px;left:5px;z-index:1}
.product-main-40 .slick-next:before, .product-main-40 .slick-prev:before {font-family:'Font Awesome\ 5 Free';font-weight:900;color:#000;font-size:16px}
...
@media (max-width:767px) {
	...
	.product-main-40 .item-main-40 {padding-left:2px;padding-right:2px}
	.product-main-40 .product-description .product-name a {font-size:13px}
	.product-main-40 .product-description .title-price {font-size:13px}
	.product-main-40 .product-description .line-through {font-size:11px}
}
<?php } ?>
</style>
