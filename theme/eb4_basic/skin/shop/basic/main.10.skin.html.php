...
<style>
.product-main-10.row {margin-left:-10px;margin-right:-10px}
.product-main-10 .col-sm-3 {padding-left:10px;padding-right:10px}
.product-main-10 .item-main-10 {position:relative;border:1px solid #e5e5e5;background:#fff;margin-bottom:20px;-webkit-transition:all 0.2s ease-in-out;-moz-transition:all 0.2s ease-in-out;-o-transition:all 0.2s ease-in-out;transition:all 0.2s ease-in-out}
.product-main-10 .product-img {position:relative;overflow:hidden;margin:10px;background:#fff}
.product-main-10 .product-img:after {content:"";position:absolute;display:block;left:0;top:0;opacity:0;-moz-transition:all 0.2s ease 0s;-webkit-transition:all 0.2s ease 0s;-ms-transition:all 0.2s ease 0s;-o-transition:all 0.2s ease 0s;transition:all 0.2s ease 0s;width:100%;height:100%;background:rgba(0,0,0,0.3)}
...
.product-main-10 .product-description .product-name {position:relative;overflow:hidden;margin:10px 0 0;margin-bottom:5px;height:40px}
.product-main-10 .product-description .product-name a {font-size:15px;font-weight:bold;color:#000}
.product-main-10 .product-description .product-name a:hover {color:#FF4848;text-decoration:underline}
.product-main-10 .product-description .title-price {font-size:16px;font-weight:bold;color:#E52700}
...
.product-main-10 .product-description .product-info {position:relative;overflow:hidden;height:34px;color:#959595;font-size:11px;margin-top:8px}
...
@media (min-width:768px) and (max-width:1199px) {
    .product-main-10.row {margin-left:-5px;margin-right:-5px}
    .product-main-10 .col-sm-3 {width:33.33333%;float:left;padding-left:5px;padding-right:5px}
}
@media (max-width:767px) {
    .product-main-10.row {margin-left:-2px;margin-right:-2px}
    .product-main-10 .col-sm-3 {width:50%;float:left;padding-left:2px;padding-right:2px}
    ...
    .product-main-10 .product-description .product-description-in {padding:0 5px 10px}
    .product-main-10 .product-description-bottom {padding:7px 5px}
}
<?php } ?>
</style>

<div class="product-main-10 row">
