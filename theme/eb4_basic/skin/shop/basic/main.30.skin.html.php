...
.product-main-30 .item-main-wrap {padding:10px;width:25%;float:left}
...
.product-main-30 .product-img-in .discount-percent {position:absolute;top:-40px;left:-40px;width:80px;height:80px;padding-top:57px;text-align:center;background:#cc2300;color:#fff;font-style:italic;font-size:.75rem;-webkit-transform:rotate(-45deg);-moz-transform:rotate(-45deg);transform:rotate(-45deg)}
...
.product-main-30 .product-description .title-price {font-size:1.125rem;font-weight:700;color:#cc2300;margin-right:7px}
...
@media (max-width:1199px) {
    ...
    .product-main-30 .item-main-wrap {width:33.33333%;padding:5px}
}
...
@media (max-width:767px) {
    ...
    .product-main-30 .item-main-wrap {padding:5px 2px}
}
</style>
