...
<style>
.product-main-30 {font-size:.9375rem}
.product-main-30 {margin-left:-10px;margin-right:-10px}
.product-main-30:after {content:"";display:block;clear:both}
.product-main-30 .item-main-wrap {padding:10px;width:20%;float:left}
.product-main-30 .item-main-wrap:nth-child(5n+1) {clear:left}
.product-main-30 .item-main-30 {position:relative;-webkit-transition:all 0.2s ease-in-out;transition:all 0.2s ease-in-out}
.product-main-30 .product-img {position:relative;overflow:hidden;border-radius:7px;margin-bottom:10px;background:#fff}
...
.product-main-30 .product-description .product-name {position:relative;overflow:hidden;margin:10px 0 5px;font-size:1.125rem;font-weight:700;line-height:1.4;height:48px}
...
.product-main-30 .product-description .title-price {font-size:1.125rem;font-weight:700;color:#ab0000;margin-right:7px}
.product-main-30 .product-description .line-through {font-size:.9375rem;color:#959595;text-decoration:line-through;font-weight:400;white-space:nowrap}
...
.product-main-30 .product-description .product-sns ul li a {display:block;width:28px;height:28px;display:flex;align-items:center;justify-content:center;background:#a5a5a5}
.product-main-30 .product-description .product-sns ul li img {width:12px;height:12px}
.product-main-30 .product-description .product-sns ul li:hover .wish-icon {background:#ab0000}
.product-main-30 .product-description .product-sns ul li:hover .facebook-icon {background:#39558f}
.product-main-30 .product-description .product-sns ul li:hover .twitter-icon {background:#252525}
...
.product-main-30 .shop-rgba-red {background:#ab0000}
...
@media (max-width:1399px) {
    .product-main-30 .item-main-wrap {width:25%}
    .product-main-30 .item-main-wrap:nth-child(5n+1) {clear:none}
    .product-main-30 .item-main-wrap:nth-child(4n+1) {clear:left}
}
@media (max-width:1199px) {
    .product-main-30 {margin-left:-5px;margin-right:-5px}
    .product-main-30 .item-main-wrap {padding:10px 5px}
}
@media (max-width:991px) {
    .product-main-30 .item-main-wrap {width:33.33333%}
    .product-main-30 .item-main-wrap:nth-child(4n+1) {clear:none}
    .product-main-30 .item-main-wrap:nth-child(3n+1) {clear:left}
    .product-main-30 .item-main-wrap:last-child {display:none}
}
@media (max-width:767px) {
    .product-main-30 {margin-left:-2px;margin-right:-2px}
    .product-main-30 .item-main-wrap {width:50%;padding:10px 2px}
    .product-main-30 .item-main-wrap:nth-child(3n+1) {clear:none}
    .product-main-30 .item-main-wrap:nth-child(2n+1) {clear:left}
    .product-main-30 .item-main-wrap:last-child {display:block}
}
</style>
