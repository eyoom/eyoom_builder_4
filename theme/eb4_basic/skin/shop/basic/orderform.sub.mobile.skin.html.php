    ...
    <div class="order-payment-info">
        ...
        <div class="payment-select-wrap">
            ...
            if($default['de_easy_pay_use']) {
                ...
                $multi_settle++;
            ?>
            <input type="radio" id="od_settle_easy_pay" name="od_settle_case" value="간편결제" <?php echo $checked; ?>><label for="od_settle_easy_pay" class="payment-select-box <?php echo $pg_easy_pay_name; ?>"><?php echo $pg_easy_pay_name; ?></label>
            <?php $checked = ''; } ?>
