<?php
/**
 * skin file : /theme/THEME_NAME/skin/eblatest/notice_roll_shop/eblatest.skin.html.php
 */
            ...
            <li>
                <a href="<?php echo $data['href']; ?>" class="ellipsis">
                    ...
                    <div class="notice-date">
                        <?php echo $eb_latest['li_date_type'] == '1' ? $eb->date_time("{$eb_latest['li_date_kind']}",$data['wr_datetime']):  $eb->date_format("{$eb_latest['li_date_kind']}",$data['wr_datetime']); ?>
                    </div>
                </a>
            </li>
            <?php }} else { ?>
