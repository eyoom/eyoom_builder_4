    ...
    <div class="adm-edit-btn btn-edit-mode" style="top:0;text-align:right">
        <div class="btn-group">
            ...
            <button type="button" class="ae-btn-info" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-html="true" data-bs-content="
                ...
                1. 배너마스터 제목 : 메인 배너<br>
                2. 배너마스터 스킨 : basic<br>
                3. EB배너 아이템 링크수 : 1개<br>
                4. EB배너 아이템 이미지수 : 2개<br>
...
<style>
.ebs-basic-wrap-<?php echo $bn_code; ?> {position:relative}
.ebs-basic-wrap-<?php echo $bn_code; ?> .slick-dotted.slick-banner {margin-bottom:0}
...
<div class="ebs-basic-wrap-<?php echo $bn_code; ?>">
            ...
            <div class="ebs-basic-item">
                ...
                <?php } ?>
                    <picture>
                        ...
                        <img src="<?php echo $item['bi_img_url']?>" alt="">
                    </picture>
                    <?php if ($item['bi_title'] || $item['bi_subtitle'] || $item['bi_text']) { ?>
                    <div class="ebs-basic-cont">
                        ...
                        <?php } ?>
                        <?php if ($item['bi_text']) { ?>
                        <p><?php echo stripslashes($item['bi_text']); ?></p>
                        <?php } ?>
                    </div>
                    <?php } ?>
                <?php if ($item['bi_href']) { ?>
        ...
        <div class="ebs-basic">
            <div class="ebs-basic-item">
                <picture>
                    ...
                    <source srcset="<?php echo $ebbanner_skin_url; ?>/image/01_m.jpg" media="(max-width:767px)">
            ...
            <div class="ebs-basic-item">
                <picture>
                    ...
                    <source srcset="<?php echo $ebbanner_skin_url; ?>/image/02_m.jpg" media="(max-width:767px)">
...
$(window).load(function(){
    $('.ebs-basic-wrap-<?php echo $bn_code; ?> .ebs-basic-in').show();
    $('.ebs-basic-wrap-<?php echo $bn_code; ?> .ebs-basic').slick({
        slidesToShow: 1,
        arrows: true,
        dots: true,
        autoplay: true,
