<?php
/**
 * core file : /eyoom/core/mypage/myfollower.php
 */
 ...
 * 사용자 프로그램
 */
@include_once(EYOOM_USER_PATH.'/mypage/myfollower.php');

/**
 * HTML 출력
 */
include_once($eyoom_skin_path['mypage'].'/myfollower.skin.html.php');