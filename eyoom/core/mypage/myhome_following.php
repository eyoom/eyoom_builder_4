<?php
/**
 * core file : /eyoom/core/mypage/myhome_following.php
 */
...
$sql = "select {$fields} from {$g5['eyoom_follow']} as a left join {$g5['member_table']} as b on a.fo_mb_id = b.mb_id left join {$g5['eyoom_member']} as c on b.mb_id = c.mb_id where a.fo_my_id = '{$user['mb_id']}' limit {$from_record}, $page_rows ";
