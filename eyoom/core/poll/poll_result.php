<?php
/**
 * core file : /eyoom/core/poll/poll_result.php
 */
...
if (!file_exists($poll_skin_path.'/poll_result.skin.html.php')) die('skin error');
include_once ($poll_skin_path.'/poll_result.skin.html.php');
