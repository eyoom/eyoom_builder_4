<?php
/**
 * @file    /adm/eyoom_admin/core/member/visit_date.php
 */
...
$sql = " select vs_date, vs_count as cnt {$sql_common} {$sql_search} order by vs_date desc {$limit} ";
