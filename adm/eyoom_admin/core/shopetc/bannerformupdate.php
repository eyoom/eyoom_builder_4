<?php
/**
 * @file    /adm/eyoom_admin/core/shopetc/bannerformupdate.php
 */
...
if ($w == "" || $w == "u")
{
    ...
    alert($msg, G5_ADMIN_URL . "/?dir=shopetc&amp;pid=bannerform&amp;w=u&amp;bn_id=$bn_id");
} else {
    alert($msg, G5_ADMIN_URL . "/?dir=shopetc&amp;pid=bannerlist");
}