...
if ($act_button == "선택수정") {
    ...
    for ($i=0; $i<$post_count_chk; $i++) {
        ...
        $bn_state = isset($_POST['bn_state'][$k]) ? clean_xss_tags($_POST['bn_state'][$k]): '';
        $bn_no = isset($_POST['bn_no'][$k]) ? clean_xss_tags($_POST['bn_no'][$k]): '';
        $bn_code = isset($_POST['bn_code'][$k]) ? clean_xss_tags($_POST['bn_code'][$k]): '';
