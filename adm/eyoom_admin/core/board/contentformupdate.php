<?php
/**
 * @file    /adm/eyoom_admin/core/board/contentformupdate.php
 */
...
if ($w == "" || $w == "u") {
    ...
    if ($error_msg) {
        alert($error_msg, G5_ADMIN_URL . "/?dir=board&amp;pid=contentform&amp;w=u&amp;co_id=$co_id");
    } else {
        alert($msg, G5_ADMIN_URL . "/?dir=board&amp;pid=contentform&amp;w=u&amp;co_id=$co_id");
    }
}
else
{
