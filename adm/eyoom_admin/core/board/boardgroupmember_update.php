<?php
/**
 * @file    /adm/eyoom_admin/core/board/boardgroupmember_update.php
 */
...
if ($w == 'ld') {
    goto_url(G5_ADMIN_URL.'/?dir=board&amp;pid=boardgroupmember_list&amp;gr_id='.$gr_id);
} else {
    goto_url(G5_ADMIN_URL.'/?dir=board&amp;pid=boardgroupmember_form&amp;mb_id='.$mb_id);
}
