<?php
/**
 * @file    /adm/eyoom_admin/core/board/qa_config_update.php
 */
...
if ($error_msg) {
    alert($error_msg, G5_ADMIN_URL . '/?dir=board&amp;pid=qa_config');
} else {
    alert('1:1문의 설정을 적용하였습니다.', G5_ADMIN_URL . '/?dir=board&amp;pid=qa_config');
}