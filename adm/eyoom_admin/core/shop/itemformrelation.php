<?php
/**
 * @file    /adm/eyoom_admin/core/shop/itemformrelation.php
 */
...
for($i=0;$row=sql_fetch_array($result);$i++) {
    ...
    $list .= '<div class="list_item_btn"><button type="button" class="add_item btn-e btn-e-xs btn-e-red">추가</button></div>';
    $list .= '</li>'.PHP_EOL;
}
...
if($list)
    ...
    $list = '<p class="relation-sbox">등록된 상품이 없습니다.</p>';
