 ...
 * 결제금액 자동입력 체크박스
 */
$html_receipt_chk = '<label class="checkbox" for="od_receipt_chk"><input type="checkbox" id="od_receipt_chk" value="'.$od['od_misu'].'" onclick="chk_receipt_price()"><i></i> 결제금액 입력</label>';
