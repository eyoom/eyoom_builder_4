<?php
/**
 * @file    /adm/eyoom_admin/core/shop/inorderformupdate.php
 */
...
echo 'document.location.href = "' . G5_ADMOIN_URL . '/?dir=shop&pid=orderform&od_id='.$od_id.'";'.PHP_EOL;
echo 'else'.PHP_EOL;
echo 'document.location.href = "' . G5_ADMOIN_URL . '/?dir=shop&pid=inorderlist&'.str_replace('&amp;', '&', $qstr).'";'.PHP_EOL;
echo '</script>'.PHP_EOL;