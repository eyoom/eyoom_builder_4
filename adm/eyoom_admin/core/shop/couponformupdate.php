<?php
/**
 * @file    /adm/eyoom_admin/core/shop/couponformupdate.php
 */
...
if($_POST['cp_type'] && ($_POST['cp_price'] < 1 || $_POST['cp_price'] > 99))
    alert('할인비율은 1과 99사이 값으로 입력해 주십시오.');
...
if($w == '') {
    ...
    if(!$cp['cp_id'])
        alert('쿠폰정보가 존재하지 않습니다.', G5_ADMIN_URL . '/?dir=shop&amp;pid=couponlist');
...
goto_url(G5_ADMIN_URL . '/?dir=shop&amp;pid=couponlist');