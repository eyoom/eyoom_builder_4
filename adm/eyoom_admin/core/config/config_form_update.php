...
$sql = " update {$g5['config_table']}
            set cf_title = '{$cf_title}',
                ...
                cf_use_version_alarm = '{$_POST['cf_use_version_alarm']}',
                cf_write_limit = '{$_POST['cf_write_limit']}',
                cf_write_limit_type = '{$_POST['cf_write_limit_type']}',
                cf_use_counsel = '{$_POST['cf_use_counsel']}',
                cf_counsel_part = '{$_POST['cf_counsel_part']}',
                cf_counsel_status = '{$_POST['cf_counsel_status']}',
                cf_counsel_sendmail = '{$_POST['cf_counsel_sendmail']}',
