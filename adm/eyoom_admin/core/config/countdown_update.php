 ...
 * POST 변수 할당
 */
$countdown['cd_title'] = get_text($_POST['cd_title']);
$countdown['cd_use'] = clean_xss_tags($_POST['cd_use']);
$countdown['cd_skin'] = clean_xss_tags($_POST['cd_skin']);
 ...
 * 페이지 리턴
 */
alert('공사중 설정을 적용하였습니다.', G5_ADMIN_URL.'/?dir=config&amp;pid=countdown');