 ...
 * @file    ~/theme/THEME_NAME/skin/member/visit_year.html.php
 */
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="text-center">
                            <a href="<?php echo G5_ADMIN_URL; ?>/?dir=member&pid=visit_month&fr_date=<?php echo $list[$i]['key']; ?>-01-01&to_date=<?php echo $list[$i]['key']; ?>-12-31"><?php echo $list[$i]['key']; ?></a>
                        </td>
                        <td>
