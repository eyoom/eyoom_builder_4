 ...
 * @file    ~/theme/THEME_NAME/skin/member/visit_search.html.php
 */
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <th><a href="<?php echo G5_ADMIN_URL; ?>/?dir=member&pid=visit_search&sfl=vi_ip&amp;stx=<?php echo $list[$i]['ip']; ?>"><?php echo $list[$i]['ip']; ?></a></th>
                        <td><?php echo $list[$i]['link'].$list[$i]['title']; ?><?php echo $list[$i]['link'] ? '</a>' : ''; ?></td>
