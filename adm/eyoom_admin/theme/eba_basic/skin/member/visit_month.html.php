 ...
 * @file    ~/theme/THEME_NAME/skin/member/visit_month.html.php
 */
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="text-center">
                            <a href="<?php echo G5_ADMIN_URL; ?>/?dir=member&pid=visit_date&fr_date=<?php echo $list[$i]['key']; ?>-01&to_date=<?php echo $list[$i]['key']; ?>-31"><?php echo $list[$i]['key']; ?></a>
                        </td>
                        <td>
