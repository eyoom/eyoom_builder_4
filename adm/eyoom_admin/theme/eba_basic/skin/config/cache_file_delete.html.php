 ...
 * @file    ~/theme/THEME_NAME/skin/config/cache_file_delete.html.php
 */
...
<div class="admin-cache-file-delete">
    <div class="adm-form-table">
        <div class="adm-form-header"><strong><i class="las la-caret-right m-r-10"></i>캐시파일 일괄삭제</strong></div>
        ...
        <div class="adm-form-cont">
            ...
            <?php foreach ($print_html as $key => $cache_file) { ?>
            <p class="li-p-sq"><?php echo $cache_file; ?></p>
            <?php } ?>
        </div>
        <div class="adm-form-cont">
            <p class="li-p-sq">최신글 캐시파일 <span class="text-crimson"><?php echo $cnt; ?></span> 건 삭제 완료됐습니다.</p>
