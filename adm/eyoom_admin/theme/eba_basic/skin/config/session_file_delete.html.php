 ...
 * @file    ~/theme/THEME_NAME/skin/config/session_file_delete.html.php
 */
...
<div class="admin-session-file-delete">
    <div class="adm-form-table">
        <div class="adm-form-header"><strong><i class="las la-caret-right m-r-10"></i>세션파일 일괄삭제</strong></div>
        ...
        <div class="adm-form-cont">
            ...
            <?php foreach ($print_html as $key => $session_file) { ?>
            <p class="li-p-sq"><?php echo $session_file; ?></p>
            <?php } ?>
        </div>
        <div class="adm-form-cont">
            <p class="li-p-sq">세션데이터 <span class="text-crimson"><?php echo $cnt; ?></span> 건 삭제 완료됐습니다.</p>
