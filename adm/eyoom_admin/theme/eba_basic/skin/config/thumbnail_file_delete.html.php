 ...
 * @file    ~/theme/THEME_NAME/skin/config/thumbnail_file_delete.html.php
 */
...
<div class="admin-thumbnail-file-delete">
    <div class="adm-form-table">
        <div class="adm-form-header"><strong><i class="las la-caret-right m-r-10"></i>썸네일파일 일괄삭제</strong></div>
