 ...
 * @file    ~/theme/THEME_NAME/skin/shop/itemuselist.html.php
 */
...
<style>
.admin-shop-itemuselist .itemuselist-image {width:80px;margin:0 auto}
.admin-shop-itemuselist .itemuselist-image img {display:block;max-width:100%;height:auto}
</style>
...
<div class="admin-shop-itemuselist">
    ...
    <div class="m-b-5">
        <div class="float-start f-s-13r">
            <a href="<?php echo G5_ADMIN_URL; ?>/?dir=<?php echo $dir; ?>&amp;pid=<?php echo $pid; ?>">[전체목록]</a><span class="m-l-10 m-r-10 text-light-gray">|</span>전체 후기내역 <?php echo number_format($total_count); ?>건
        </div>
    ...
    <form name="fitemuselist" method="post" action="<?php echo $action_url1; ?>" onsubmit="return fitemuselist_submit(this);" autocomplete="off" class="eyoom-form">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <th>
                            <input type="hidden" name="is_id[<?php echo $i; ?>]" value="<?php echo $list[$i]['is_id']; ?>" id="is_id_<?php echo $i; ?>">
                        ...
                        <td class="text-center">
                            <a href="<?php echo G5_ADMIN_URL; ?>/?dir=shop&amp;pid=itemuseform&amp;is_id=<?php echo $list[$i]['is_id']; ?>&amp;w=u<?php echo $qstr ? '&amp;'.$qstr:''; ?>"><u>수정</u></a>
                        </td>
                        <td>
                            <div class="itemuselist-image"><a href="<?php echo $list[$i]['href']; ?>" target="_blank"><?php echo $list[$i]['image']; ?></a></div>
                        </td>
                        <td>
                        ...
                        <td><?php echo get_text($list[$i]['is_subject']); ?></td>
                        <td class="text-center"><?php echo $list[$i]['is_name']; ?></td>
                        <td class="text-center">
                            <label for="score_<?php echo $i; ?>" class="select width-150px"><select name="is_score[<?php echo $i; ?>]" id="score_<?php echo $i; ?>"><option value="5" <?php echo $list[$i]['is_score'] == '5' ? 'selected':''; ?>>매우만족</option><option value="4" <?php echo $list[$i]['is_score'] == '4' ? 'selected':''; ?>>만족</option><option value="3" <?php echo $list[$i]['is_score'] == '3' ? 'selected':''; ?>>보통</option><option value="2" <?php echo $list[$i]['is_score'] == '2' ? 'selected':''; ?>>불만</option><option value="1" <?php echo $list[$i]['is_score'] == '1' ? 'selected':''; ?>>매우불만</option></select><i></i></label>
                        </td>
                        <td class="text-center"><?php echo date("Y-m-d", strtotime($list[$i]['is_time'])); ?></td>
                    </tr>
                    <?php } ?>
