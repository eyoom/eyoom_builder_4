 ...
 * @file    ~/theme/THEME_NAME/skin/sms/install.html.php
 */
if (!defined('_EYOOM_IS_ADMIN_')) exit;
?>

<style>
#sms5_install {padding:0}
</style>
...
<div id="sms5_install">
    ...
    <div class="m-t-20 m-b-20">
        <button type="button" id="sms5_btn_next" disabled class="btn-e btn-e-lg btn-e-crimson" onclick="location.href='<?php echo G5_ADMIN_URL; ?>/?dir=sms&pid=config';">SMS 기본설정</button>
    </div>
</div>
