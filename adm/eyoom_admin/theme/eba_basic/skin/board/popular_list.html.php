 ...
 * @file    ~/theme/THEME_NAME/skin/board/popular_list.html.php
 */
...
<div class="admin-popular-list">
    ...
    <div class="m-b-5 f-s-13r">
        <a href="<?php echo G5_ADMIN_URL; ?>/?dir=<?php echo $dir; ?>&amp;pid=<?php echo $pid; ?>">[전체목록]</a><span class="m-l-10 m-r-10 text-light-gray">|</span>건수 <?php echo number_format($total_count); ?>개
    </div>
                    ...
                    <tr>
                        <th>
                            <label class="checkbox adm-table-check">
                                <input type="checkbox" name="chk[]" id="chk_<?php echo $i; ?>" value="<?php echo $list[$i]['pp_id']; ?>"><i></i>
                            </label>
                        </th>
                        <td>
                            <a href="<?php echo G5_ADMIN_URL; ?>/?dir=board&amp;pid=popular_list&amp;sfl=pp_word&amp;stx=<?php echo $list[$i]['word']; ?>"><?php echo $list[$i]['word']; ?></a>
                        </td>
                        <td class="text-center"><?php echo $list[$i]['pp_date']; ?></td>
                        <td><?php echo $list[$i]['pp_ip']; ?></td>
                    </tr>
                    <?php } ?>
