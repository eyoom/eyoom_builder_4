 ...
 * @file    ~/theme/THEME_NAME/skin/theme/ebslider_list.html.php
 */
...
<div class="admin-ebslider-list">
    ...
    <div class="f-s-13r m-b-5">
        <a href="<?php echo G5_ADMIN_URL; ?>/?dir=<?php echo $dir; ?>&amp;pid=<?php echo $pid; ?>">[전체목록]</a><span class="m-l-10 m-r-10 text-light-gray">|</span>EB슬라이더 마스터 <?php echo number_format($total_count); ?>개
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <th>
                            ...
                            <input type="hidden" name="es_no[<?php echo $i; ?>]" value="<?php echo $list[$i]['es_no']; ?>">
                            <input type="hidden" name="es_code[<?php echo $i; ?>]" value="<?php echo $list[$i]['es_code']; ?>">
                        </th>
                        <td class="text-center">
                            <a href="<?php echo G5_ADMIN_URL; ?>/?dir=theme&amp;pid=ebslider_form&amp;es_code=<?php echo $list[$i]['es_code']; ?>&amp;w=u"><u>수정</u></a>
                        </td>
                        <td><?php echo get_text($list[$i]['es_subject']); ?></td>
                        <td>
                            <div class="eb-clipboard"><div id="subs_code_<?php echo $i; ?>" class="eb-clipboard-cont"><?php echo $list[$i]['es_chg_code']; ?></div><div class="eb-clipboard-btn" data-clipboard-target="#subs_code_<?php echo $i; ?>">코드복사</div></div>
                        </td>
                        <td>
                            <label class="select width-200px"><select name="es_state[<?php echo $i; ?>]" id="es_state_<?php echo $i; ?>"><option value="">선택</option><option value="1" <?php echo  $list[$i]['es_state'] == '1' ? 'selected':''; ?>>보이기</option><option value="2" <?php echo  $list[$i]['es_state'] == '2' ? 'selected':''; ?>>숨기기</option></select><i></i></label>
                        </td>
                        <td class="text-center"><?php echo substr($list[$i]['es_regdt'], 0, 10); ?></td>
                    </tr>
                    <?php } ?>
