 ...
 * @file    ~/theme/THEME_NAME/skin/shopetc/sale1year.html.php
 */
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="text-center">
                            <a href="<?php echo G5_ADMIN_URL; ?>/?dir=shopetc&amp;pid=sale1month&amp;fr_month=<?php echo preg_replace('/-/','',$list[$i]['od_date']); ?>01&amp;to_month=<?php echo preg_replace('/-/','',$list[$i]['od_date']); ?>12"><u><?php echo $list[$i]['od_date']; ?></u></a>
                        </th>
