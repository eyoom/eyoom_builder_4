 ...
 * @file    ~/theme/THEME_NAME/skin/shopetc/sale1month.html.php
 */
...
<div class="admin-shop-sale1month">
    <div class="adm-headline">
        <h3><?php echo $fr_month; ?> ~ <?php echo $to_month; ?> 월간 매출현황</h3>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="text-center">
                            <a href="<?php echo G5_ADMIN_URL; ?>/?dir=shopetc&amp;pid=sale1date&amp;fr_date=<?php echo preg_replace('/-/','',$list[$i]['od_date']); ?>01&amp;to_date=<?php echo preg_replace('/-/','',$list[$i]['od_date']); ?>31"><u><?php echo $list[$i]['od_date']; ?></u></a>
                        </th>
