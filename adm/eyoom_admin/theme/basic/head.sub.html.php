...
add_stylesheet('<link rel="stylesheet" href="'.EYOOM_ADMIN_THEME_URL.'/plugins/waves/waves.min.css?ver='.G5_CSS_VER.'">',0);
...
add_stylesheet('<link rel="stylesheet" href="'.EYOOM_ADMIN_THEME_URL.'/css/style.css?ver='.G5_CSS_VER.'" type="text/css" media="screen">',0);
add_stylesheet('<link rel="stylesheet" href="'.EYOOM_ADMIN_THEME_URL.'/css/custom.css?ver='.G5_CSS_VER.'" type="text/css" media="screen">',0);
?>
<!--[if lte IE 8]>
