...
!function () {
    ...
    db.clients   = [
        <?php for ($i=0; $i<$cnt; $i++) { ?>
        {
            주문월: "<a href='<?php echo G5_ADMIN_URL; ?>/?dir=shopetc&amp;pid=sale1date&amp;fr_date=<?php echo preg_replace('/-/','',$list[$i]['od_date']); ?>01&amp;to_date=<?php echo preg_replace('/-/','',$list[$i]['od_date']); ?>31'><?php echo $list[$i]['od_date']; ?></a>",
