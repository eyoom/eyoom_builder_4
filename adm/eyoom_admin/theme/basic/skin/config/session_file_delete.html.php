 ...
 * @file    ~/theme/basic/skin/config/session_file_delete.html.php
 */
...
<div class="admin-session-file-delete">
    ...
    <div class="margin-bottom-15">
        <strong class="font-size-14 color-red">
            ...
            <span class="color-black">세션데이터 <span class="color-red"><?php echo $cnt; ?></span> 건 삭제 완료됐습니다.</span>
        </strong>
    </div>
