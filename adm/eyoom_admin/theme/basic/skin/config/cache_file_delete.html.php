 ...
 * @file    ~/theme/basic/skin/config/cache_file_delete.html.php
 */
...
<div class="admin-cache-file-delete">
    ...
    <div class="margin-bottom-15">
        <strong class="font-size-14 color-red">
            ...
            <span class="color-black">최신글 캐시파일 <span class="color-red"><?php echo $cnt; ?></span> 건 삭제 완료됐습니다.</span>
        </strong>
    </div>
