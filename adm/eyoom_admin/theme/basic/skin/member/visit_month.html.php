 ...
 * @file    ~/theme/basic/skin/member/visit_month.html.php
 */
...
!function () {
    ...
    db.clients   = [
        ...
        {
            년월일: "<a href='<?php echo G5_ADMIN_URL; ?>/?dir=member&pid=visit_date&fr_date=<?php echo $list[$i]['key']; ?>-01&to_date=<?php echo $list[$i]['key']; ?>-31'><?php echo $list[$i]['key']; ?></a>",
