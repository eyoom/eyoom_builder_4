 ...
 * @file    ~/theme/basic/skin/member/visit_device.html.php
 */
...
!function () {
    ...
    db.clients   = [
        <?php for ($i=0; $i<count((array)$list); $i++) { ?>
        {
            ...
            접속기기: "<?php echo $list[$i]['link']; ?><?php echo $list[$i]['key']; ?><?php echo $list[$i]['link2']; ?>",
