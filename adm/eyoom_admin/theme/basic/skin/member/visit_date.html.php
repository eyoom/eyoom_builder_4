 ...
 * @file    ~/theme/basic/skin/member/visit_date.html.php
 */
...
!function () {
    ...
    db.clients   = [
        ...
        {
            년월일: "<a href='<?php echo G5_ADMIN_URL; ?>/?dir=member&pid=visit_list&fr_date=<?php echo $list[$i]['key']; ?>&to_date=<?php echo $list[$i]['key']; ?>'><?php echo $list[$i]['key']; ?></a>",
