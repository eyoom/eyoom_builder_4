 ...
 * @file    ~/theme/basic/skin/sms/sms_write.html.php
 */
...
#sms5_send h2 {font-size:14px;font-weight:bold;margin:10px 0 20px;padding:0}
#sms5_send #send_emo {position:relative;top:inherit;left:inherit;margin:0;padding:10px;border:0;width:auto;background:#fff;border:1px solid #dadada}
#sms5_send #send_write {position:relative;top:inherit;left:inherit;margin:0;padding:10px !important;border:0;width:auto;background:#fff;height:inherit;min-height:680px;border:1px solid #dadada}
#sms5_send #send_book {margin:0;padding:10px;border:0;background:#fff;height:inherit;min-height:680px;border:1px solid #dadada}
#sms5_send #sms_byte {top:-50px}
#sms5_send .write_scemo_btn {line-height:1.2}
#sms5_send .write_scemo {left:100%}
#sms5_send .write_inner {left:inherit;padding:10px 0;width:inherit}
#sms5_send .write_floater {position:absolute;top:5px;right:10px}
#sms5_send .btn_confirm {position:relative;overflow:hidden;margin:20px 0 0}
...
<div class="admin-sms-write">
    ...
    <div class="alert alert-info">
        <p>회원정보 최근 업데이트 : <?php echo $sms5['cf_datetime']?></p>
    </div>
            ...
            <div class="col-md-3 md-margin-bottom-30">
                <div id="send_write">
                    ...
                    <div class="btn_confirm01 btn_confirm">
                        <input type="submit" value="전송" class="btn-e btn-e-xlg btn-e-red btn-e-block">
    ...
    <div class="adm-table-form-wrap margin-bottom-30">
        <div class="cont-text-bg">
            <p class="bg-info font-size-12 margin-bottom-0">
                ...
                SMS 사용 설정은 <a href="<?php echo G5_ADMIN_URL; ?>/?dir=config&amp;pid=config_form#anc_cf_sms" class="btn-e btn-e-lg btn-e-purple">환경설정 &gt; 기본환경설정 &gt; SMS설정</a> 에서 SMS 사용을 아이코드로 변경해 주셔야 사용하실수 있습니다.
            </p>
        </div>
    </div>
    <?php } ?>
