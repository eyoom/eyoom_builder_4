 ...
 * @file    ~/theme/basic/skin/theme/ebcontents_skins.html.php
 */
...
.ebcontents-skin-form .adm-headline h3 {margin:10px 0 30px}
.ebcontents-skin-form ul {margin:0;border:1px solid #e5e5e5;padding:4px}
.ebcontents-skin-form ul:after {content:"";display:block;clear:both}
.ebcontents-skin-form ul li {width:120px;height:auto;padding:5px;border:1px solid #e5e5e5;float:left;margin:4px}
.ebcontents-skin-form ul li .skin-img {position:relative;overflow:hidden;width:108px;height:108px}
.ebcontents-skin-form ul li h6 {position:relative;overflow:hidden;height:32px;text-align:center;font-size:12px;line-height:1.4;margin:8px 0}
</style>
