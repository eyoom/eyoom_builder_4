...
<div class="admin-ebcontents-form">
    <div class="adm-headline margin-top-30">
        <h3>EB콘텐츠 아이템</h3>
        <a href="<?php echo G5_ADMIN_URL; ?>/?dir=theme&amp;pid=ebcontents_itemlist&amp;ec_code=<?php echo $ec_item['ec_code'] ? $ec_item['ec_code']:$ec_code; ?>&amp;wmode=1" class="btn-e btn-e-dark btn-e-lg">목록보기</a>
