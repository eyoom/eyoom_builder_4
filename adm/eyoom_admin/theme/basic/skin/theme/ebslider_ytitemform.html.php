 ...
 * @file    ~/theme/basic/skin/theme/ebslider_ytitemform.html.php
 */
...
<div class="admin-ebslider-form">
    ...
    <div class="adm-table-form-wrap margin-bottom-30">
        <header><strong><i class="fas fa-caret-right"></i> EB슬라이더 유튜브동영상 아이템 설정</strong></header>
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <label for="ei_ytcode" class="input form-width-250px">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <label for="ei_quality" class="select form-width-150px">
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="ei_volumn" class="select form-width-150px">
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="ei_stime" class="input">
                                ...
                                <input type="text" name="ei_stime" id="ei_stime" value="<?php echo $es_item['ei_stime'] ? $es_item['ei_stime']:'0'; ?>">
                            </label>
                        </td>
                    <?php if (G5_IS_MOBILE) { ?>
                    </tr>
                    ...
                    <?php } ?>
                        ...
                        <td>
                            <label for="ei_etime" class="input">
                                <i class="icon-append">초</i>
                                <input type="text" name="ei_etime" id="ei_etime" value="<?php echo $es_item['ei_etime'] ? $es_item['ei_etime']:'0'; ?>">
                            </label>
