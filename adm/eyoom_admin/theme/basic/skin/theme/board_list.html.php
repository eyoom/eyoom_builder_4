...
!function () {
    ...
    db.clients   = [
        <?php for ($i=0; $i<count((array)$list); $i++) { ?>
        {
            ...
            게시판: "<a href='<?php echo G5_BBS_URL; ?>/board.php?bo_table=<?php echo $list[$i]['bo_table']; ?>&wmode=1' onclick='eb_modal(this.href); return false;'><u>보기</u></a> <a href='<?php echo short_url_clean(G5_BBS_URL.'/write.php?bo_table='.$list[$i]['bo_table']); ?>&wmode=1' onclick='eb_modal(this.href); return false;' class='margin-left-10'><u>글쓰기</u></a> <a href='<?php echo G5_BBS_URL; ?>/board.php?bo_table=<?php echo $list[$i]['bo_table']; ?>' target='_blank' class='margin-left-5'><u>바로가기</u></a>",
