...
!function () {
    ...
    db.clients   = [
        <?php for ($i=0; $i<$bo_cnt; $i++) { ?>
        {
            ...
            게시판: "<a href='<?php echo get_eyoom_pretty_url($list[$i]['bo_table']); ?>' target='_blank'><u>보기</u></a> <a href='<?php echo short_url_clean(G5_BBS_URL.'/write.php?bo_table='.$list[$i]['bo_table']); ?>' target='_blank' class='margin-left-5'><u>글쓰기</u></a> <a href='<?php echo get_eyoom_pretty_url($list[$i]['bo_table']); ?>?theme=<?php echo $theme; ?>' target='_blank' class='margin-left-5'><u>바로가기</u></a>",
