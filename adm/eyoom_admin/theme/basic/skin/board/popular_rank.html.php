 ...
 * @file    ~/theme/basic/skin/board/popular_rank.html.php
 */
...
<div class="admin-popular-rank">
    <form id="form" name="form" class="eyoom-form" method="get">
...
!function () {
    ...
    db.clients   = [
        <?php for ($i=0; $i<count($list); $i++) { ?>
        {
            ...
            검색회수: "<?php echo number_format($list[$i]['cnt']); ?>",
        },
        <?php } ?>
    ]
}();
...
$(document).ready(function() {
    $("#popular-list").jsGrid({
        ...
        height         : "auto",
        fields         : [
            { name: "순위", type: "text", align: "center", width: 80 },
            { name: "검색어", type: "text", width: 200 },
            { name: "검색회수", type: "text", align: "center", width: 100 },
        ]
    });
});
