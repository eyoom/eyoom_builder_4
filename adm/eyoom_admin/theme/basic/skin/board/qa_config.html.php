...
<div class="admin-qa-config">
    ...
    <div class="adm-table-form-wrap margin-bottom-30">
        <header><strong><i class="fas fa-caret-right"></i> 1:1문의 설정</strong></header>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <div class="inline-group">
                                ...
                                <span>
                                    <a href="<?php echo G5_BBS_URL; ?>/qalist.php" target="_blank" class="btn-e btn-e-md btn-e-dark">1:1문의 바로가기</a>
                                </span>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <label class="input form-width-250px">
                                ...
                                <input type="text" name="qa_subject_len" value="<?php echo $qaconfig['qa_subject_len']; ?>" id="qa_subject_len" class="text-right" required>
                            </label>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <label class="input form-width-250px">
                                ...
                                <input type="text" name="qa_page_rows" value="<?php echo $qaconfig['qa_page_rows']; ?>" id="qa_page_rows" class="text-right" required>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <label class="input form-width-250px">
                                <i class="icon-append">개</i>
                                <input type="text" name="qa_mobile_page_rows" value="<?php echo $qaconfig['qa_mobile_page_rows']; ?>" id="qa_mobile_page_rows" class="text-right" required>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <label class="input form-width-250px">
                                ...
                                <input type="text" name="qa_image_width" value="<?php echo $qaconfig['qa_image_width']; ?>" id="qa_image_width" class="text-right" required>
                            </label>
                            ...
                            <div class="inline-group">
                                ...
                                <span>
                                    <label class="input form-width-250px">
                                        ...
                                        <input type="text" name="qa_upload_size" id="qa_upload_size" value="<?php echo $qaconfig['qa_upload_size']; ?>" required class="text-right">
                                    </label>
                                </span>
                                <span>이하</span>
                            </div>
                            <div class="note margin-bottom-10" style="margin-top:10px;"><strong>Note:</strong> 최대 <?php echo ini_get("upload_max_filesize"); ?> 이하 업로드 가능, 1 MB = 1,048,576 bytes</div>
                        </td>
                    </tr>
                    <tr>
                        <th class="table-form-th">
