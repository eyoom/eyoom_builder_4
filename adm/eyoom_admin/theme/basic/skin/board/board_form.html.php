                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="inline-group">
                                    ...
                                    <?php } else if (!$wmode) { ?>
                                    <span> <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $board['bo_table'] ?>" class="btn-e btn-e-yellow">게시판 바로가기</a></span>
                                    <?php } ?>
                                </div>
                            </td>
                        </tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="note"><strong>Note:</strong> 게시물 보기 페이지에서 게시물 전체목록을 보디오록 설정합니다.</div>
                            </td>
                            <td class="table-chk-td">
                                <div class="inline-group">
