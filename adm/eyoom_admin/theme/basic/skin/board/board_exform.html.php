 ...
 * @file    ~/theme/basic/skin/board/board_exform.html.php
 */
...
<div class="admin-exboard-form">
    ...
    <div id="exboard-config">
        <div class="adm-form-wrap">
            <fieldset>
                <div class="row">
                    <div class="col col-2">
                        <section>
                            <label class="label">확장필드명</label>
                            <label for="ex_fname" class="input">
                    ...
                    <div class="col col-4">
                        <section>
                            <label class="label">필드명칭</label>
                            <label for="ex_subject" class="input">
                    ...
                    <div class="col col-6">
                        <section>
                            <label class="label">검색필드 적용</label>
                            <label for="ex_use_search" class="checkbox"><input type="checkbox" name="ex_use_search" id="ex_use_search" value="y" <?php echo $exinfo['ex_use_search'] == 'y' ? 'checked':''; ?>><i></i>사용</label>
            ...
            <fieldset>
                <div class="row">
                    <div class="col col-6">
                        <section>
                            <label class="label">폼타입</label>
                            <label for="ex_form" class="select">
                    ...
                    <div class="col col-6">
                        <section>
                            <label class="label">필수항목 여부</label>
                            <label for="ex_required" class="checkbox"><input type="checkbox" name="ex_required" id="ex_required" value="y" <?php echo $exinfo['ex_required'] == 'y' ? 'checked': ''; ?>><i></i>필수</label>
            ...
            <fieldset class="ex_detail_info">
                <div class="row">
                    <div class="col col-3">
                        <section>
                            <label class="label">필드종류</label>
                            <label for="ex_type" class="select">
                    ...
                    <div class="col col-3 ex_except_info">
                        <section>
                            <label class="label">길이</label>
                            <label for="ex_length" class="input">
                    ...
                    <div class="col col-3 ex_except_info">
                        <section>
                            ...
                            <label for="ex_default" class="input">
            ...
            <fieldset class="ex_item_info">
                <div class="row">
                    <div class="col col-12">
                        <section>
                            <label class="label">아이템 항목</label>
                            <label for="ex_item_value" class="textarea">
                                <textarea name="ex_item_value" id="ex_item_value"><?php echo $exinfo['ex_item_value']; ?></textarea>
                            </label>
                            <div class="note"><strong>Note:</strong> 구분자(<strong class="color-red">|</strong>)를 이용하여 항목을 입력해 주세요. 예) 예<strong class="color-red">|</strong>아니오</div>
                        </section>
                    </div>
                </div>
            </fieldset>
