 ...
 * @file    ~/theme/basic/skin/shop/couponform.html.php
 */
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="inline-mix">
                                <label class="input input-button display-inline-block form-width-250px margin-right-10">
                                    <input type="text" name="mb_id" id="mb_id" value="<?php echo stripslashes($cp['mb_id']); ?>">
                                    <div class="button"><a href="javascript:;" id="sch_member" onclick="return false;"><i class="fas fa-search"></i> 회원검색</a></div>
                                </label>
