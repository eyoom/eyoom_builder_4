 ...
 * @file    ~/theme/basic/skin/shop/itemtypelist.html.php
 */
...
<div class="admin-shop-itemtypelist">
    ...
    <form name="fitemtypelist" method="post" action="<?php echo $action_url1; ?>" autocomplete="off" class="eyoom-form">
...
!function () {
    ...
    db.clients   = [
        <?php for ($i=0; $i<count((array)$list); $i++) { ?>
        {
            ...
            히트상품: "<label class='checkbox'><input type='checkbox' name='it_type1[<?php echo $i; ?>]' id='it_type1_<?php echo $i; ?>' value='1' <?php echo $list[$i]['it_type1'] ? 'checked':''; ?>><i></i></label>",
            추천상품: "<label class='checkbox'><input type='checkbox' name='it_type2[<?php echo $i; ?>]' id='it_type2_<?php echo $i; ?>' value='1' <?php echo $list[$i]['it_type2'] ? 'checked':''; ?>><i></i></label>",
            신규상품: "<label class='checkbox'><input type='checkbox' name='it_type3[<?php echo $i; ?>]' id='it_type3_<?php echo $i; ?>' value='1' <?php echo $list[$i]['it_type3'] ? 'checked':''; ?>><i></i></label>",
            인기상품: "<label class='checkbox'><input type='checkbox' name='it_type4[<?php echo $i; ?>]' id='it_type4_<?php echo $i; ?>' value='1' <?php echo $list[$i]['it_type4'] ? 'checked':''; ?>><i></i></label>",
            할인상품: "<label class='checkbox'><input type='checkbox' name='it_type5[<?php echo $i; ?>]' id='it_type5_<?php echo $i; ?>' value='1' <?php echo $list[$i]['it_type5'] ? 'checked':''; ?>><i></i></label>",
        },
        <?php } ?>
    ]
}();
...
$(document).ready(function(){
    $("#admin-shop-itemtypelist").jsGrid({
        ...
        fields         : [
            ...
            { name: "제품명", type: "text", width: 300 },
            { name: "히트상품", type: "text", align: "center", width: 60 },
            { name: "추천상품", type: "text", align: "center", width: 60 },
            { name: "신규상품", type: "text", align: "center", width: 60 },
            { name: "인기상품", type: "text", align: "center", width: 60 },
            { name: "할인상품", type: "text", align: "center", width: 60 },
        ]
    })
    $("#sort").click(function() {
        var field = $("#sortingField").val();
        $("#admin-shop-itemtypelist").jsGrid("sort", field);
    });
});
