...
!function () {
    ...
    db.clients   = [
        <?php for ($i=0; $i<count((array)$list); $i++) { ?>
        {
            ...
            재고수정: "<label class='input'><input type='text' name='it_stock_qty[<?php echo $i; ?>]' id='stock_qty_<?php echo $i; ?>' value='<?php echo $list[$i]['it_stock_qty']; ?>' autocomplete='off'>",
            통보수량: "<label class='input'><input type='text' name='it_noti_qty[<?php echo $i; ?>]' id='noti_qty_<?php echo $i; ?>' value='<?php echo $list[$i]['it_noti_qty']; ?>' autocomplete='off'>",
