...
<div class="admin-shop-itemlist">
    <div class="adm-headline adm-headline-btn">
        ...
        <div class="headline-btn">
            ...
            <?php if (!G5_IS_MOBILE) { ?>
            <a href="<?php echo G5_ADMIN_URL; ?>/?dir=shop&pid=itemexcel&wmode=1" onclick="return eb_modal(this.href);return false;" class="btn-e btn-e-teal btn-e-lg"><i class="fas fa-plus"></i> 상품일괄등록</a>
            <?php } ?>
        </div>
    </div>
...
$(document).ready(function(){
    $("#admin-shop-itemlist").jsGrid({
        ...
        fields         : [
            ...
            { name: "판매수량", type: "number", width: 80 },
