 ...
 * @file    ~/theme/basic/skin/shop/itemqalist.html.php
 */
        ...
        <div class="col col-9">
            <div class="margin-bottom-5">
                <span class="font-size-12 color-grey">
                    <a href="<?php echo G5_ADMIN_URL; ?>/?dir=<?php echo $dir; ?>&amp;pid=<?php echo $pid; ?>">[전체목록]</a><span class="margin-left-10 margin-right-10 color-light-grey">|</span>상품문의 <?php echo number_format($total_count); ?>건
                </span>
            </div>
        </div>
        <div class="col col-3">
...
!function () {
    ...
    db.clients   = [
        <?php for ($i=0; $i<count((array)$list); $i++) { ?>
        {
            ...
            질문: "<a href='#' class='qa_href' onclick='return false;' target='<?php echo $i; ?>'><?php echo get_text($list[$i]['iq_subject']); ?></a>",
            이름: "<?php echo $list[$i]['iq_name']; ?>",
            답변여부: "<?php echo $list[$i]['answer']; ?>",
            등록일: "<?php echo date("Y-m-d", strtotime($list[$i]['iq_time'])); ?>",
        },
        <?php } ?>
    ]
}();
...
$(document).ready(function(){
    $("#admin-shop-itemqalist").jsGrid({
        ...
        fields         : [
            ...
            { name: "질문", type: "text", width: 300 },
            { name: "이름", type: "text", width: 100 },
            { name: "답변여부", type: "text", width: 80 },
