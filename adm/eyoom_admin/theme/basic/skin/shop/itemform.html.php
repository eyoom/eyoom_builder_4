...
<div class="admin-shop-itemform">
    ...
    <div id="anc_sitfrm_cate">
        ...
        <div class="adm-table-form-wrap margin-bottom-30">
            <header class="border-bottom-1px"><strong><i class="fas fa-caret-right"></i> 상품분류 선택</strong></header>
            <fieldset>
                            ...
                            <td>
                                <div class="inline-group">
                                    <label class="checkbox">
                                        <input type="checkbox" name="it_type1" id="it_type1" value="1" <?php echo ($it['it_type1'] ? "checked" : ""); ?>><i></i> 히트
                                        <span class="label label-dark color-white"><span class="font-size-11">히트</span></span>
                                    </label>
                                    <label class="checkbox">
                                        <input type="checkbox" name="it_type2" id="it_type2" value="1" <?php echo ($it['it_type2'] ? "checked" : ""); ?> ><i></i> 추천
                                        <span class="label label-yellow color-white"><span class="font-size-11">추천</span></span>
                                    </label>
                                    <label class="checkbox">
                                        <input type="checkbox" name="it_type3" id="it_type3" value="1" <?php echo ($it['it_type3'] ? "checked" : ""); ?> ><i></i> 신상품
                                        <span class="label label-red color-white"><span class="font-size-11">신상</span></span>
                                    </label>
                                    <label class="checkbox">
                                        <input type="checkbox" name="it_type4" id="it_type4" value="1" <?php echo ($it['it_type4'] ? "checked" : ""); ?>><i></i> 인기
                                        <span class="label label-green color-white"><span class="font-size-11">베스트</span></span>
                                    </label>
                                    <label class="checkbox">
                                        <input type="checkbox" name="it_type5" id="it_type5" value="1" <?php echo ($it['it_type5'] ? "checked" : ""); ?>><i></i> 할인
                                        <span class="label label-purple color-white"><span class="font-size-11">할인</span></span>
                                    </label>
                                </div>
    ...
    <div id="anc_sitfrm_compact">
        ...
        <div class="adm-table-form-wrap margin-bottom-30">
            <header class="border-bottom-1px"><strong><i class="fas fa-caret-right"></i> 상품요약정보</strong></header>
            <fieldset>
                <div class="cont-text-bg">
                    <p class="bg-info font-size-12 margin-bottom-0">
            ...
            <header><strong><i class="fas fa-caret-right"></i> 상품요약정보 상세설정</strong></header>
    ...
    <div id="anc_sitfrm_cost">
        ...
        <div class="adm-table-form-wrap margin-bottom-30">
            <header><strong><i class="fas fa-caret-right"></i> 가격 및 재고</strong></header>
            <div class="table-list-eb">
                <?php if (!G5_IS_MOBILE) { ?>
                <div class="table-responsive">
                <?php } ?>
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="note margin-bottom-10"><strong>Note:</strong> 옵션항목은 콤마(,) 로 구분하여 여러개를 입력할 수 있습니다. 옷을 예로 들어 [옵션1 : 사이즈 , 옵션1 항목 : XXL,XL,L,M,S] , [옵션2 : 색상 , 옵션2 항목 : 빨,파,노]<br><strong>옵션명과 옵션항목에 따옴표(', ")는 입력할 수 없습니다.</strong></div>
                                <div class="sit_option">
                                    <div class="sit-option-list">
                                        <div class="sit-option-item">
                                            <div class="inline-group">
                                                <span class="form-width-70px"><label for="opt1_subject">옵션1</label></span>
                                                <span>
                                                    <label class="input form-width-250px">
                                        ...
                                        <div class="sit-option-item">
                                            <div class="inline-group">
                                                <span class="form-width-70px"><label for="opt1">옵션1 항목</label></span>
                                                <span>
                                                    <label class="input form-width-250px">
                                    ...
                                    <div class="sit-option-list">
                                        <div class="sit-option-item">
                                            <div class="inline-group">
                                                <span class="form-width-70px"><label for="opt2_subject">옵션2</label></span>
                                                <span>
                                                    <label class="input form-width-250px">
                                        ...
                                        <div class="sit-option-item">
                                            <div class="inline-group">
                                                <span class="form-width-70px"><label for="opt2">옵션2 항목</label></span>
                                                <span>
                                                    <label class="input form-width-250px">
                                    ...
                                    <div class="sit-option-list">
                                        <div class="sit-option-item">
                                            <div class="inline-group">
                                                <span class="form-width-70px"><label for="opt3_subject">옵션3</label></span>
                                                <span>
                                                    <label class="input form-width-250px">
                                        ...
                                        <div class="sit-option-item">
                                            <div class="inline-group">
                                                <span class="form-width-70px"><label for="opt3">옵션3 항목</label></span>
                                                <span>
                                                    <label class="input form-width-250px">
                                    ...
                                    <div class="text-center margin-top-10 margin-bottom-10">
                                        <button type="button" id="option_table_create" class="btn-e btn-e-md btn-e-purple">옵션목록생성</button>
                                    </div>
                                </div>
                                <?php if (G5_IS_MOBILE) { ?>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="note margin-bottom-10"><strong>Note:</strong> 옵션항목은 콤마(,) 로 구분하여 여러개를 입력할 수 있습니다. 스마트폰을 예로 들어 [추가1 : 추가구성상품 , 추가1 항목 : 액정보호필름,케이스,충전기]<br><strong>옵션명과 옵션항목에 따옴표(', ")는 입력할 수 없습니다.</strong></strong></div>
    ...
    <div id="anc_sitfrm_sendcost">
        ...
        <div class="adm-table-form-wrap margin-bottom-30">
            <header class="border-bottom-1px"><strong><i class="fas fa-caret-right"></i> 배송비</strong></header>
            <fieldset>
                <div class="cont-text-bg">
                    <p class="bg-info font-size-12 margin-bottom-0">
            ...
            <div class="table-list-eb">
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr id="sc_con_method">
                            <th class="table-form-th">
                                <label for="it_sc_method" class="label">배송비 결제</label>
                            </th>
                            <td>
                                <label class="select form-width-250px">
    ...
    <div id="anc_sitfrm_img">
        ...
        <div class="adm-table-form-wrap margin-bottom-30">
            <header><strong><i class="fas fa-caret-right"></i> 이미지 업로드</strong></header>
                                ...
                                <div class="table-form-thumb">
                                    ...
                                    <div class="table-form-thumb-file">
                                        <label class="input input-file">
                                            <div class="button"><input type="file" name="it_img<?php echo $i; ?>" id="it_img<?php echo $i; ?>" onchange="this.parentNode.nextSibling.value = this.value">이미지 업로드</div><input type="text" readonly="">
                                        </label>
                                        <?php if ($itimg['thumb']) { ?>
                                        ...
                                        <a class="goods-thumb-btn btn-e btn-e-xs btn-e-default" data-gall="goods_image_<?php echo $i; ?>" href="<?php echo G5_DATA_URL; ?>/item/<?php echo $itimg['img_name']; ?>" title="<?php echo $itimg['img_name']; ?>">확대보기</a>
                                        <?php } ?>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
    ...
    <div id="anc_sitfrm_relation" class="srel">
        ...
        <div class="adm-table-form-wrap border-bottom-1px">
            <header class="border-bottom-1px"><strong><i class="fas fa-caret-right"></i> 관련상품</strong></header>
            <fieldset>
                <div class="cont-text-bg">
                    <p class="bg-info font-size-12 margin-bottom-0">
                ...
                <div class="row">
                    <div class="col col-6">
                        ...
                        <div class="inline-mix margin-top-5 margin-bottom-10">
                            ...
                            <label class="input input-button display-inline-block width-50">
                                <input type="text" name="sch_name" id="sch_name"><div class="button"><a href="javascript:;" id="btn_search_item" onclick="return false;"><i class="fas fa-search"></i> 검색</a></div>
                            </label>
                        </div>
                    ...
                    <div class="col col-6">
                        ...
                        <div id="reg_relation" class="relation-sbox-margin-top">
                            ...
                            <?php } else { ?>
                            <p class="relation-sbox">선택된 상품이 없습니다.</p>
                            <?php } ?>
                        </div>
    ...
    <div id="anc_sitfrm_event">
        ...
        <div class="adm-table-form-wrap border-bottom-1px">
            <header><strong><i class="fas fa-caret-right"></i> 관련이벤트</strong></header>
            <fieldset>
                <div class="row">
                    <div class="col col-6">
                        <section>
                    ...
                    $(function() {
                        ...
                        $(document).on("click", "#reg_event_list .del_event", function() {
                            ...
                            var count = $("#reg_event_list li").size();
                            if(count < 1)
                                $("#reg_event_list").html("선택된 이벤트가 없습니다.");
                        });
                    });
                    </script>
    ...
    <div id="anc_sitfrm_optional">
        ...
        <div class="adm-table-form-wrap margin-bottom-30">
            <header><strong><i class="fas fa-caret-right"></i> 상세설명설정</strong></header>
